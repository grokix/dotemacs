(defun color-theme-tangotango ()
  ...
  (color-theme-install
   '(color-theme-tango
     ...
     (mode-line ((t (:foreground "#bbbbbc" :background "#222222" :box)))) ;box in up changes scroll...
     ...
     (font-lock-string-face ((t (:foreground "#ad7fa8")))) ;italic strings ugly
     ...
     (org-level-1 ((t (:bold t :foreground "dodger blue" :height 1.00))))
     (org-level-2 ((t (:bold t :foreground "#6ac214" :height 1.0))))
     (org-level-3 ((t (:bold t :foreground "#edd400" :height 1.00))))
     (org-level-4 ((t (:bold t :foreground "cyan" :height 1.00))))
     (org-level-5 ((t (:bold t :foreground "green" :height 1.00))))
     (org-level-6 ((t (:bold t :foreground "gold" :height 1.00))))
     (org-level-7 ((t (:bold t :foreground "brown" :height 1.00))))
     (org-level-8 ((t (:bold t :foreground "aquamarine" :height 1.00))))
     (org-level-9 ((t (:bold t :foreground "green yellow" :height 1.00))))
     (org-level-10 ((t (:bold t :foreground "lemon chiffon" :height 1.00))))
     (org-level-11 ((t (:bold t :foreground "salmon" :height 1.00))))
